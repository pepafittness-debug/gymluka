    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <header className="fixed top-0 w-full z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 text-white font-semibold text-lg drop-shadow-lg">
            <a href="#uvod" className="hover:text-red-500 transition">ÚVOD</a>
            <a href="#info" className="hover:text-red-500 transition">INFORMACE</a>
            <a href="#galerie" className="hover:text-red-500 transition">FOTKY</a>
          </nav>
        </div>
      </header>
      ...
      {/* Info Section */}
      <section id="info" className="py-20 bg-zinc-800">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-black text-white text-center mb-16 uppercase">
            Informace
          </h2>

          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Opening Hours */}
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                <Clock className="w-8 h-8 text-red-500" />
                <h3 className="text-2xl font-bold text-white uppercase">Otevírací doba</h3>
              </div>
            ...
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white uppercase">Ceník</h3>
              </div>
              <div className="space-y-3 text-gray-300 text-lg">
                <p className="flex justify-between">
                  <span className="font-semibold">1 vstup:</span>
                  <span className="text-red-500 font-bold">100 Kč</span>
                </p>
                <p className="flex justify-between">
                  <span className="font-semibold">Měsíční členství:</span>
                  <span className="text-red-500 font-bold">900 Kč</span>
                </p>
                <p className="flex justify-between">
            ...
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white uppercase">Adresa</h3>
              </div>
            ...
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white uppercase">Kontakt</h3>
              </div>
          ...
          <div className="max-w-4xl mx-auto mt-12 bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
            <h3 className="text-2xl font-bold text-white mb-4 uppercase">Vybavení</h3>
      ...
      <section className="py-20 bg-zinc-800">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1 mb-8">
              <div className="flex items-center gap-3 mb-6">
                <Users className="w-8 h-8 text-red-500" />
                <h3 className="text-2xl font-bold text-white uppercase">Profesionální tréninky</h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-zinc-800 p-6 border border-red-600/50">
                  <h4 className="text-xl font-bold text-red-500 mb-3">Co nabízíme:</h4>
                ...
                <div className="bg-zinc-800 p-6 border border-red-600/50">
                  <h4 className="text-xl font-bold text-red-500 mb-3">Ceny za osobní trénink:</h4>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex justify-between">
                      <span>1 trénink:</span>
                      <span className="text-red-500 font-bold">400 Kč</span>
                    </li>
                    <li className="flex justify-between">
                      <span>5 tréninků:</span>
                      <span className="text-red-500 font-bold">1800 Kč</span>
                    </li>
                    <li className="flex justify-between">
                      <span>10 tréninků:</span>
                      <span className="text-red-500 font-bold">3500 Kč</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-zinc-900 p-8 border-2 border-red-600 transition-all duration-300 hover:border-red-400 hover:shadow-lg hover:shadow-red-600/30 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white uppercase">Kvalitní doplňky stravy</h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-zinc-800 p-6 border border-red-600/50">
                  <h4 className="text-xl font-bold text-red-500 mb-4">Produkty v nabídce:</h4>
                  <ul className="text-gray-300 space-y-2">
                ...
                <div className="bg-zinc-800 p-6 border border-red-600/50">
                  <h4 className="text-xl font-bold text-red-500 mb-4">Proč si koupit u nás:</h4>
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-red-500 font-bold mt-1">•</span>
              ...
              <p className="text-gray-300 text-lg mt-8 text-center font-semibold">
      ...
      {/* Gallery Section */}
      <section id="galerie" className="py-20 bg-zinc-900">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-black text-white text-center mb-16 uppercase">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-7xl mx-auto">
            {[...Array(10)].map((_, i) => (
              <button
                ...
                className="aspect-square bg-zinc-800 border-2 border-red-600 flex items-center justify-center hover:border-red-400 transition-all duration-300 hover:scale-105 cursor-pointer"
              >
                <span className="text-gray-600 text-sm">Fotka {i + 1}</span>
              </button>
            ))}
          </div>
        </div>
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          <div className="relative max-w-5xl w-full">
            <div className="aspect-square bg-zinc-800 border-4 border-red-600 flex items-center justify-center">
